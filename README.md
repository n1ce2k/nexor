...
Ключ спрашивается при установке, но его можно ввести и позже:
...
Без действующего ключа сайт работает в редакции Lite, а в панели висит плашка. Публичная часть не блокируется никогда: сломанная лицензия не должна ронять сайт клиента.
