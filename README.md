...
**Инфоблоки.** Типы инфоблоков → инфоблоки → разделы-деревья → элементы. У каждого инфоблока свой набор свойств; форма элемента строится из них в рантайме. У элемента есть картинка анонса и картинка описания — обе кладутся перетаскиванием на поле или выбором по клику, показываются превью и убираются крестиком.
